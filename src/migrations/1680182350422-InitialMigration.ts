...
export class InitialMigration1680182350422 implements MigrationInterface {
    name = 'InitialMigration1680182350422'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "contact" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "email" character varying(50), "name" character varying(50) NOT NULL, "telefone" character varying(15) NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "userId" uuid, CONSTRAINT "UQ_dc4b6846a3b6dfdc0d23c7e3d98" UNIQUE ("telefone"), CONSTRAINT "PK_2cbbe00f59ab6b3bb5b8d19f989" PRIMARY KEY ("id"))`);
